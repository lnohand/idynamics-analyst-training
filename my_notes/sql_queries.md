...
## **Opening MRR (as of March 31, 2026\)**
...
FROM subscriptions s  
INNER JOIN customers c ON s.customer\_id \= c.customer\_id  
WHERE s.start\_date \<= '2026-03-31'  
 AND (s.cancelled\_date IS NULL OR s.cancelled\_date \> '2026-03-31')  
ORDER BY mrr DESC;
...
## **Expansion / Contraction Events (March 2026\)**
...
WHERE e.event\_date BETWEEN '2026-03-01' AND '2026-03-31'  
